  ...
  >
    <span
      ...
      css={css`
        ...
        height: calc(
          ${hamburgerLayerHeight} * 3 + ${hamburgerLayerSpacing} * 2
        );
        display: inline-block;
        position: relative;
    ...
    >
      <span
        ...
        css={css`
          ...
          &:before {
            top: calc(
              (${hamburgerLayerSpacing} + ${hamburgerLayerHeight}) * -1
            );
          ...
          &:after {
            ...
            left: ${isMenuOpen ? `none` : `calc(${hamburgerLayerWidth} * 0.4)`};

            // Slider-r
            top: calc(
              (${hamburgerLayerHeight} * 2) + (${hamburgerLayerSpacing} * 2)
            );
            transform: ${isMenuOpen
